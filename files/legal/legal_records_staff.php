...
<html>
<head>
	<title>CRS-Adopted Registration (Staff)</title>
	<meta charset="utf-8">
  ...
  <!--nav-side-->
    <div class="aside" style="margin-top: 3em;">
      ...
      <div class="row">
          ...
          <div class="col-sm-3">
            <a class="btn btn-outline-info btn-block" href="birth_records_staff.php" style="overflow:auto;">View Birth Records</a>
        </div>
      </div>
		<br>
  		<div class="table-responsive">
  		<h5 style="text-transform:uppercase;" align="center">-- Adopted Records --</h5>
            ...
            if ($conn->connect_error) die($conn->connect_error);
				      ...
				      $sql= "SELECT registration_tbl.registry_no, registration_tbl.no, registration_tbl.reg_user, registration_tbl.reg_date, registration_tbl.reg_time, registration_tbl.update_user, registration_tbl.update_date, registration_tbl.update_time, child_tbl.* 
	                  ...
	                  <td>
	                      <a href="legal_cerf_edit_staff.php?reg_no=<?php echo $row['no']; ?>" class='btn btn-light btn-sm'><strong>Edit</strong></a>
	                  </td>
                      <td>
