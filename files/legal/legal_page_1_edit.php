	  			...
	  			<div class="row"><!--grid of header-->
		  			...
		  			<div class="col-3" id="book" style="border: 2px solid green; border-left:none; border-bottom:none;">
		     			<div class="form-group">
							...
							<input type="text" class="bookNo form-control form-control-sm" id="txt" id="bookno" name="book_no" value="<?php echo $row['book_no']; ?>" disabled="">

							<label id="ltxt">Page No.</label>
							<input type="text" class="pageNo form-control form-control-sm" id="txt" name="page_no" value="<?php echo $row['page_no']; ?>" disabled>
			  	...
			  	<div class="row"><!--row of city-->
				  	...
				  	<div class="col-3" id="book" style="border: 2px solid green;border-left:none; border-top: none;">
				    	<div class="form-group">
					  		...
					  		<input type="text" class="regNo form-control form-control-sm" name="registry_no" id="txt" value="<?php echo $row['registry_no']; ?>" style="font-family:century gothic;font-weight:bold;" disabled>
						</div>
				  	</div>
			  	</div><!--close row-->
			<!-- Child Info -->
		  			...
		  			<div class="col" style="border: 2px solid green; border-left: none; border-top: none;">
		  				...
		  				<div class="row" style="border-top: 2px solid green;">
					  		...
					  		<div class="col-7">
					  			...
					  			<div class="input-group">
							    	<input type="text" class="form-control form-control-sm" name="child_birth_date" style="word-spacing: 5em; text-align:center;" value="<?php echo $row['child_birth_date'] ?>">
							    </div>
							</div>
			    		</div><!--close row-->
				  	    <div class="row" style="border-top: 2px solid green;">
		  				...
		  				<div class="row" style="border-top: 2px solid green;">
					  		...
					  		<div class="col-3">
					  			<div class="row">
							    	...
							    	<input type="text" class="form-control form-control-sm" name="marriage_date" style="word-spacing: 2em;" value="<?php echo $row['marriage_date']; ?>">
					  		</div>
		  			...
		  			<div class="col">
			  			<div class="row">
			  				<div class="col">
									...
									<input type="time" class="form-control form-control-sm" name="birth_time" style="text-align:center;" value="<?php echo $row['birth_time']; ?>">
								</div>
