...
<div class="row" id="row">
  	...
  	<div class="col-sm-9" style="padding-top: 7%;" id="body">
  		<div class="row">
  			...
  			<div class="col-sm-3">
				<a class="btn btn-outline-info btn-block" href="birth_records.php" style="overflow:auto;">View Birth Records</a>
			</div>
  		</div>
		<br>
		  	...
		  	<table class="table table-striped table-sm">
		    	...
		    	<tbody id="myTable">
					...
					if ($conn->connect_error) die($conn->connect_error);
	                  ...
	                  <td>
	                      <a href="legal_cerf_edit.php?reg_no=<?php echo $row['no']; ?>" class='btn btn-light btn-sm'><strong>Edit</strong></a>
	                  </td>
	              	</tr>
	              	<?php
	                }
