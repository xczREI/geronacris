...
$pdf->Image('../../images/logo-3.png',26,33,22);
$pdf->Image('../../images/image-4.png',160,33,22);
$pdf->SetFont('','',12);
$pdf->Ln(12);
$pdf->Cell(65);
...
$pdf->Ln(6);
$pdf->Cell(65);
$pdf->Cell(30,10,'SALVADOR, LANAO DEL NORTE',0,0,'C');
$pdf->Ln(15);
$pdf->Cell(115);
...
$pdf->Cell(20);
$pdf->SetFont('','U',12);
$pdf->Write(10,'    '.$row['page_no'].'    ');
$pdf->SetFont('','',12);
$pdf->Cell(30,10,'of book number',0,0);
$pdf->SetFont('','U',12);
$pdf->Write(10,'    '.$row['book_no'].'    ');
$pdf->SetFont('','',12);
$pdf->Write(10,':');
$pdf->Ln(13);
