	  			...
	  			<div class="row"><!--grid of header-->
		  			<div class="col" style="border: 2px solid green;">
						...
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding:0; width:24%; margin-right:0;">
							<input type="text" class="form-control form-control-sm" style="background-color: white;" id="birth_date" name="birth_date" value="<?php echo $row['birth_date']; ?>">
						</div>
						at
						...
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding:0; width:7%; margin-right:0;">
							<input type="text" class="form-control form-control-sm" name="ack_sworn_day" value="<?php echo $row['sworn_day']; ?>">		
						</div>
						day of
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding:0; width:35%; margin-right:0;">
							<input type="text" class="form-control form-control-sm" name="ack_sworn_month" value="<?php echo $row['sworn_month']; ?>" onkeypress="return isTextKey(event)">
						</div>
						,
						...
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0; width: 40%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm" name="ack_ctc" value="<?php echo $row['ctc']; ?>" onkeypress="return isNumberKey(event)">
						</div>
						issued on
