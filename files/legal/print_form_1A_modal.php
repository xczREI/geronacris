<style>
  .input{
    text-transform:uppercase; border:none; font-weight:normal; font-family:arial; width:100%;
  }
  .txt{
        ...
        <form method="post" action="print_1A.php" target="_blank">
          ...
          <div class="modal-body" id="modal1A">
            ...
            <div class="form_1A" style="padding:0 30px 0 20px; width:800px;margin: auto;">
              ...
              <img src="../../images/logo-3.png" style="width:15%;float:left;padding-left:20px;">
              <h6 align="center" style="padding-top:5px;width:76%;">Republic of the Philippines<br><span style="font-weight:bold;">OFFICE OF THE CIVIL REGISTRAR</span><br>SALVADOR, LANAO DEL NORTE</h6>
              ...
              <!--<h6 align="center">Municipal Civil Registrar</h6>-->
              </div><br>
              <h6>Verified by :
              <div class="custom-control custom-checkbox custom-control-inline" style="width:40%;padding-left:0;margin-right:0;">
                <div style="width:90%;">
