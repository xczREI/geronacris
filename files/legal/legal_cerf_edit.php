  	...
  	<div class="col-sm-9" style="padding-top: 7%;" id="body">
  		...
  		<div class="row">
	  		<div class="col-sm-8 mb-1">
		  		<a href="legal_records.php" class="btn btn-light"><i class="fa fa-angle-double-left"></i> Back</a>
		...
		?>
		<form method="post" action="legal_cerf_update_action.php" id="updatelegal_form">
