...
<div class="row" id="row">
  	...
  	<div class="col-sm-9" style="padding-top: 7%;" id="body">
    	<div class="row">
    		...
    		<div class="col-sm-3">
      		<a class="btn btn-outline-info btn-block" href="legal_records.php" style=" overflow:auto;">View Adopted Records</a>
      	</div>
  		</div>
		<br>
		    	...
		    	<tbody id="myTable">
				  <?php
	                ...
	                <tr>
	                  ...
	                  <td>
	                      <a href="legal_cerf.php?reg_no=<?php echo $row['no']; ?>" class='btn btn-light btn-sm'><strong>Edit</strong></a>
	                  </td>
	              	</tr>
	              	<?php
	                }
