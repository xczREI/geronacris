  ...
  <!--nav-side-->
    <div class="aside" style="margin-top: 3em;">
  	...
  	<div class="col-sm-9" style="padding-top: 7%;" id="body">
		...
		?>
		<form method="post" action="reg_info_action_staff.php" id="updatelegal_form">

			<input type="hidden" name="reg_no" value="<?php echo $row['no']; ?>">
			  <!-- Tab panes -->
			<div id="legal_page_1" class="collapse coll show" data-parent="#accordion">
			    <?php
			        	include 'legal_page_1.php';
			   	?>
			</div>
			<div id="legal_page_2" class="collapse coll" data-parent="#accordion">
			      	<?php
			        	include 'legal_page_2.php';
			   		?>
			</div>
			<br>
	     	<button type="submit" class="btn btn-info btn-block" name="legal_update" id="btnupdate" style="font-weight:bold; letter-spacing:5px; font-size:20px;">SAVE</button>
	     	<br>
		</form>
		<?php 
			} 
...
<script src = "../../js/birth_check_regNo_js.js"></script>
