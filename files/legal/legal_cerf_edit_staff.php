...
<style>
    ...
    <style>
	    #navbar{ display: none; }
	    .coll{ overflow:visible; height:auto; }
  	...
  	<div class="col-sm-9" style="padding-top: 7%;" id="body">
  		...
  		<div class="row">
	  		<div class="col-sm-8 mb-1">
		  		<a href="legal_records_staff.php" class="btn btn-light"><i class="fa fa-angle-double-left"></i> Back</a>
		  		<button data-toggle="collapse" data-target="#legal_page_1" id="page1" class="btn btn-outline-info">Page 1</button>
				<button data-toggle="collapse" data-target="#legal_page_2" id="page2" class="btn btn-outline-info">Page 2</button>
			</div>
		...
		?>
		<form method="post" action="legal_cerf_update_action_staff.php" id="updatelegal_form">

			<input type="hidden" name="reg_no" value="<?php echo $row['no']; ?>">
			  <!-- Tab panes -->
			<div id="legal_page_1" class="collapse coll show" data-parent="#accordion">
			    <?php
			        	include 'legal_page_1_edit.php';
			   	?>
			</div>
			<div id="legal_page_2" class="collapse coll" data-parent="#accordion">
			      	<?php
			        	include 'legal_page_2_edit.php';
			   		?>
			</div>
			<br>
	     	<button type="submit" class="btn btn-info btn-block" name="update" id="btnupdate" style="font-weight:bold; letter-spacing:5px; font-size:20px;">UPDATE</button>
	     	<br>
		</form>
		<?php 
			} 
