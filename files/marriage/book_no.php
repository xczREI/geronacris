<?php
	$conn = mysqli_connect('localhost','root','','crsmarriagedb') or die ('unable to connect');
...
?>
		...
		<input type="text" class="bookNo form-control form-control-sm" id="txt" id="bookno" style="font-weight:bold;" name="book_no" value="1" >
<?php
	}else if(5 == $page){
		for ($j = 0 ; $j < $rows ; ++$j)
		{
