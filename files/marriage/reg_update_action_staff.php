<?php
    ...
    if (isset($_POST['mrg_update']) && isset($_POST['reg_no'])) 
    {
      ...
      $husband_bplace = $conn->real_escape_string($_POST['husband_bplace']);
      ...
      $husband_father_name = $conn->real_escape_string($_POST['h_fa_name']);
      $husband_father_citizen = $conn->real_escape_string($_POST['h_father_citizen']);
      $husband_mother_name = $conn->real_escape_string($_POST['h_mo_name']);
      $husband_mother_citizen = $conn->real_escape_string($_POST['h_mother_citizen']);
      $husband_person_name = $conn->real_escape_string($_POST['h_person_name']);
      ...
      $wife_bplace = $conn->real_escape_string($_POST['wife_bplace']);
      ...
      $wife_father_name = $conn->real_escape_string($_POST['w_fa_name']);
      $wife_father_citizen = $conn->real_escape_string($_POST['w_father_citizen']);
      $wife_mother_name = $conn->real_escape_string($_POST['w_mo_name']);
      $wife_mother_citizen = $conn->real_escape_string($_POST['w_mother_citizen']);
      $wife_person_name = $conn->real_escape_string($_POST['w_person_name']);
      ...
      if($_POST['late_marriage_type1']=='my marriage'){
            $late_marriage_type = $conn->real_escape_string($_POST['late_marriage_type1']); 
            ...
            $late_marriage_type = $conn->real_escape_string($_POST['late_marriage_type2']);
      ...
      if($_POST['late_sect_type1']=='religious ceremony'){
            $late_sect_type = $_POST['late_sect_type1'];    
      }else if($_POST['late_sect_type2']=='civil ceremony'){
            $late_sect_type = $_POST['late_sect_type2'];    
      }else if($_POST['late_sect_type3']=='Muslim rites'){
            $late_sect_type = $_POST['late_sect_type3'];    
      }else if($_POST['late_sect_type4']=='tribal rites'){
            $late_sect_type = $_POST['late_sect_type4'];    
      }
     ...
     $sql = "UPDATE receive_civil_tbl SET registry_no='$registry_no', received_name='$received_name', received_position='$received_position', civil_name='$civil_name', civil_position='$civil_position', received_date='$received_date', civil_date='$civil_date' WHERE no = '$reg_no'";
      ...
      header('location: marriage_records_staff.php');
