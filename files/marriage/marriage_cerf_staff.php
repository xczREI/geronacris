  ...
  <!--nav-side-->
    <div class="aside" style="margin-top: 3em;">
  	...
  	<div class="col-sm-9" style="padding-top: 7%;" id="body">
		...
		<a href="marriage_records_staff.php" class="btn btn-outline-info">View Records</a>

		<form method="post" action="reg_info_action_staff.php" id="addmarriage_form">

			<div id="marriage_page_1" class="collapse coll show" data-parent="#accordion">
				<?php
				    include 'marriage_page_1.php';
				?>
			</div>
	  		<div id="marriage_page_2" class="collapse coll" data-parent="#accordion">
	    		<?php
				     include 'marriage_page_2.php';
				?>
	  		</div>
	  		<br>
	     	<button type="submit" class="btn btn-info btn-block" name="add_marriage" id="btn_add" style="font-weight:bold; letter-spacing:5px; font-size:20px;">SAVE</button>
	     	<br>
		</form>
		</div>
