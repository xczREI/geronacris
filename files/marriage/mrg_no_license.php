						<div class="custom-control custom-checkbox custom-control-inline" style="margin-right: 0;">
								...
								<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0;width: 23%;margin-right: 0;">
									<input type="text" class="form-control form-control-sm" id="mrg_license_no" name="mrg_license_no" onkeypress="return isNumberKey(event)">
								</div>
								issued on
								<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0;width: 23%;margin-right: 0;">
								...
								at
								<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0;width: 23%;margin-right: 0;">
									<input type="text" class="form-control form-control-sm" id="mrg_license_at" name="mrg_license_at" onkeypress="return isTextKey(event)">
								</div><br>
								&emsp;&emsp;&emsp;in favor of said parties, was exhibited to me.<br>
								<div class="custom-control custom-checkbox custom-control-inline" style="margin-right: 0;">
									<input type="checkbox" class="custom-control-input" id="no_license" name="mrg_solemn_type" value="no marriage license" checked="">
								...
								<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0;width: 10%;margin-right: 0;">
									<input type="text" class="form-control form-control-sm" id="no_license_art" name="no_license_art" value="<?php echo $row['mrg_under_art'] ?>">
								</div>
