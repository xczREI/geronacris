...
$conn = new mysqli($hn, $un, $pw, $db);
    ...
    if (isset($_POST['add_death'])) 
    {
      ...
      $rel_child = $conn->real_escape_string($_POST['rel_death']);
      ...
      $late_reg_reason = $conn->real_escape_string($_POST['late_reg_reason1'].' '.$_POST['late_reg_reason2']);
      ...
      //==============================database====================================
      $sql = "INSERT INTO registration_tbl VALUES ('$registry_no' , '$book_no', '$page_no', '$province', '$municipal', '$date', '$time', '$e_name', '$u_date', '$u_time', '$u_name', '$registry_no')";
