  			...
  			<div class="col" style="border: 2px solid purple; border-top: none;">
                ...
                <div class="row" style="border-top: 1px solid purple;">
	  				<div class="col">
						...
						<div class="custom-control custom-checkbox custom-control-inline" style="padding: 0; width: 45%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="immediate_cause" onkeypress="return isTextKey(event)">
						</div>
						<div class="custom-control custom-checkbox custom-control-inline" style="padding: 0; width: 33%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="immediate_interval">
						</div>
						...
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0; width: 45%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="antecedent_cause" onkeypress="return isTextKey(event)">
						</div>
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0; width: 33%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="antecedent_interval">
						</div>
						&emsp;&emsp;&nbsp;&nbsp;Underlying cause&emsp;&nbsp;&nbsp;&nbsp;&nbsp;: c
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0; width: 45%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="underlying_cause" onkeypress="return isTextKey(event)">
						</div>
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0; width: 33%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="underlying_interval">
						</div>
						...
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0; width: 60%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="other_condition_death" onkeypress="return isTextKey(event)">
						</div>
						</h6>
	  				</div>
	    		</div>
                ...
                <div class="row" style="border-top: 2px solid purple;">
	  				<div class="col-10" style="border-right: 2px solid purple;">
						...
						<div class="custom-control custom-checkbox custom-control-inline" style="padding: 0; width: 41%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="death_manner" onkeypress="return isTextKey(event)">
						</div>
						...
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding: 0; width: 32%;margin-right: 0;">
							<input type="text" class="form-control form-control-sm"  name="place_external_cause" onkeypress="return isTextKey(event)">
						</div>
						</h6>
	  				</div>
	  				<div class="col-2">
                ...
                <div class="row" style="border-top: 2px solid purple;">
	  				<div class="col-8" style="border-right: 2px solid purple;">
							...
							<input type="checkbox" class="custom-control-input" id="physician" name="attendant" value="Private Physician">
							<label class="custom-control-label" for="physician" style="font-size: 13px;">&nbsp;1 Private<br>&emsp;Physician</label>
						</div>
						<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:3px;">
							<input type="checkbox" class="custom-control-input" id="health" name="attendant" value="Public Health Officer">
							<label class="custom-control-label" for="health" style="font-size: 13px;">&nbsp;2 Public Health<br>&emsp;Officer</label>
						</div>
						<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:3px;">
							<input type="checkbox" class="custom-control-input" id="hospital" name="attendant" value="Hospital Authority">
							<label class="custom-control-label" for="hospital" style="font-size: 13px;">&nbsp;3 Hospital<br>&emsp;Authority</label>
						</div>
						<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:3px;">
							<input type="checkbox" class="custom-control-input" id="none" name="attendant" value="None">
						...
						<div class="custom-control custom-checkbox custom-control-inline" style="width:20%;margin-right:0;padding-left:0;">
							<input type="text" class="form-control form-control-sm"  id="otherstxt" name="attendant5" onkeypress="return isTextKey(event)">
						</div>
	  				</div>
	  				<div class="col-4">
	  					...
	  					<div class="custom-control custom-checkbox custom-control-inline p-0 mr-0" style="width:40%;">
							<input type="date" class="form-control form-control-sm text-lowercase pr-0" style="font-size: 10px;font-weight:bold;" name="date_from">
						</div>
						To
						<div class="custom-control custom-checkbox custom-control-inline p-0 mr-0" style="width:41%;">
							<input type="date" class="form-control form-control-sm text-lowercase pr-0" style="font-size: 10px;font-weight:bold;" name="date_to">
						</div>
						</h6>
	  				</div>
	  			</div>
  			...
  			<div class="col">
	  			<div class="row">
	  				<div class="col">
						...
						the deceased and the death occurred at
							...
							<input type="time" class="form-control form-control-sm"  name="death_time" style="text-align:center;">
						</div>
                ...
                <div class="row">
	  				<div class="col-7" style="padding-bottom: 2px;">
						...
						<div class="input-group mt-1">
			    			...
			    			<input type="text" class="form-control form-control-sm" name="attendant_position" onkeypress="return isTextKey(event)">
						</div>
						<div class="input-group mt-1">
			  				<div class="input-group-prepend">
			      				<span class="input-group-text" style="padding:0;border:none; background-color:white; color:black;font-size:14px;">Address&nbsp;</span>
			  				</div>
			    			<input type="text" class="form-control form-control-sm" name="attendant_address" onkeypress="return isTextKey(event)">
						</div>
						<div class="custom-control custom-checkbox custom-control-inline mt-1" style="padding:0;width:45%;margin-right:0;">
			    			<input type="text" class="form-control form-control-sm" style="background-color: white;border-top:none;border-left:none;border-right:none;border-color: purple;border-radius: 0;" name="signature" disabled>
						</div>
                ...
                <div class="row" style="border-top: 2px solid purple;">
			  		...
			  		<div class="col-4" style="border-right: 2px solid purple;">
			    			...
			    			<input type="text" class="form-control form-control-sm" name="burial_no"  >
						</div>
						<div class="input-group mt-1">
			  				<div class="input-group-prepend">
			  		...
			  		<div class="col-4">
			    			...
			    			<input type="text" class="form-control form-control-sm" name="transfer_no" >
						</div>
						<div class="input-group mt-1">
			  				<div class="input-group-prepend">
			      				<span class="input-group-text" style="padding:0;border:none; background-color:white; color:black;font-size:14px;">Date Issued&nbsp;</span>
                ...
                <div class="row" style="border-top: 2px solid purple;">
			  		<div class="col">
			  		  	...
			  		  	<div class="input-group" style="padding-top:5px;">
					    	<input type="text" class="form-control form-control-sm" name="cemetery" placeholder="Name of Cemetery/Crematory"  onkeypress="return isTextKey(event)">
							<input type="text" class="form-control form-control-sm" name="municipalityCemetery" placeholder="Municipality"  onkeypress="return isTextKey(event)">
  				...
  				<div class="row">
	  				<div class="col-6" style="border-right: 2px solid purple;">
						...
						<div class="input-group mt-1">
			    			...
			    			<input type="text" class="form-control form-control-sm" name="rel_death" onkeypress="return isTextKey(event)" >
						</div>
						<div class="input-group mt-1">
			  				<div class="input-group-prepend">
			      				<span class="input-group-text" style="padding:0;border:none; background-color:white; color:black;font-size:14px;">Address&nbsp;</span>
