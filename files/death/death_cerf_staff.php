    ...
    <div class="aside" style="margin-top: 3em;">
 	...
 	<div class="col-sm-9" style="padding-top: 7%;" id="body">
 		<div id="accordion">
  		...
  		<a href="death_records_staff.php" class="btn btn-outline-info">View Records</a>

  		<form method="post" action="reg_info_action1_staff.php" id="adddeath_form">
  			<div id="death_page_1" class="collapse coll show" data-parent="#accordion">
 				<?php
			    include 'death_page_1.php';
 				?>
  			</div>
 	  		<div id="death_page_2" class="collapse coll" data-parent="#accordion">
    		<?php
			    include 'death_page_2.php';
 				?>
 	  		</div>
 	  		<br>
