	...
	<div class="row" style="border-top: 1px solid purple;">
		<div class="col">
			...
			<div class="input-group">
				<input type="text" class="form-control form-control-sm" name="age_death" style="text-align:center;text-transform:lowercase;font-size:12px;" value="<?php echo rtrim($row['age_time_of_death'],'yrs'); ?>" onkeypress="return isNumberKey(event)">
			</div>
		</div>
	</div>
</div>
