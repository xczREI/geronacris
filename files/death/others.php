<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:3px;">
	<input type="checkbox" class="custom-control-input" id="physician" name="attendant1" value="Private Physician">
	<label class="custom-control-label" for="physician" style="font-size: 13px;">&nbsp;1 Private<br>&emsp;Physician</label>
</div>
<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:3px;">
	<input type="checkbox" class="custom-control-input" id="health" name="attendant2" value="Public Health Officer">
	<label class="custom-control-label" for="health" style="font-size: 13px;">&nbsp;2 Public Health<br>&emsp;Officer</label>
</div>
<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:3px;">
	<input type="checkbox" class="custom-control-input" id="hospital" name="attendant3" value="Hospital Authority">
   	<label class="custom-control-label" for="hospital" style="font-size: 13px;">&nbsp;3 Hospital<br>&emsp;Authority</label>
</div>
<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:3px;">
	<input type="checkbox" class="custom-control-input" id="none" name="attendant4" value="None">
...
<div class="custom-control custom-checkbox custom-control-inline" style="margin-right:0;">
	<input type="checkbox" class="custom-control-input" id="others" checked="">
...
<div class="custom-control custom-checkbox custom-control-inline" style="width:20%;margin-right:0;padding-left:0;">
	<input type="text" class="form-control form-control-sm" id="otherstxt" name="attendant5" value="<?php echo $row['attendant']; ?>" onkeypress="return isTextKey(event)">
</div>
