<!-- The Modal -->
  <div class="modal fade" id="my103">
    <div class="modal-dialog">
      <div class="modal-content">
      
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Form No. 103</h4>
        ...
        ?>
        <form method="post" action="print_103.php" target="_blank">
          <input type="hidden" name="reg_no" value="<?php echo $row['no']; ?>">
          <!-- Modal body -->
          <div class="modal-body">
            <h6 align="center" style="text-transform:uppercase;">Are you sure you want to print the <br>Form No. 103 of</h6>
