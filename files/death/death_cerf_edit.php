  		...
  		<div id="accordion">
	  		<div class="row">
		  		<div class="col-sm-6 mb-1">
	  				<a href="death_records.php" class="btn btn-light"><i class="fa fa-angle-double-left"></i> Back</a>
				...
				<div class="col-sm-2 pr-0">
					<button type="button" id="edit_btn" class="btn btn-outline-dark btn-block" data-toggle="modal" data-target="#my103reprint">Reprint</button>
				</div>
			</div>
			...
			<form method="post" action="death_cerf_update_action.php" id="adddeath_form">
