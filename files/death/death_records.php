...
<div class="row" id="row">
 	...
 	<div class="col-sm-9" style="padding-top: 7%;" id="body">
 		<div class="row">
 			...
 			<div class="col-sm-2">
				<a class="btn btn-outline-info btn-block" href="death_cerf.php" style="overflow:auto;">Data Entry</a>
			</div>
 		</div>
		<br>
	  	...
	  	<table class="table table-hover table-sm">
        	...
        	<?php
				    ...
				    if ($conn->connect_error) die($conn->connect_error);
				      ...
				      $sql= "SELECT * FROM registration_tbl NATURAL JOIN person_tbl  ORDER BY last_name ASC";
              ...
              <tr>
                ...
                <td>
                  <a href="death_cerf_edit.php?reg_no=<?php echo $row['no']; ?>" class='btn btn-light btn-sm'><strong>Edit</strong></a>
                </td>
             	</tr>
           	<?php
              }
