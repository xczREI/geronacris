...
<div class="col-4" style="border-right: 1px solid purple;">
	...
	<div class="row" style="border-top: 1px solid purple;">
		<div class="col-6" style="border-right: 1px solid purple;">
			...
			<div class="input-group">
				<input type="text" class="form-control form-control-sm" name="age_one_month" onkeypress="return isNumberKey(event)">
			</div>
		</div>
		<div class="col-6">
			<h6 style="margin:0;font-size:10px;" align="center">[0]Days</h6>
			<div class="input-group">
				<input type="text" class="form-control form-control-sm" name="age_one_day" onkeypress="return isNumberKey(event)">
			</div>
		</div>
	</div>			
</div>
<div class="col-4">
	...
	<div class="row" style="border-top: 1px solid purple;">
		<div class="col-6" style="border-right: 1px solid purple;">
			...
			<div class="input-group">
				<input type="text" class="form-control form-control-sm" name="age_hrs_hrs" value="<?php echo $row['age_time_of_death']; ?>" onkeypress="return isNumberKey(event)">
			</div>
		</div>
		<div class="col-6">
			<h6 style="margin:0;font-size:10px;" align="center">Min/Sec</h6>
			<div class="input-group">
				<input type="text" class="form-control form-control-sm" name="age_hrs_min" value="<?php echo $row['age_day_min']; ?>" onkeypress="return isNumberKey(event)">
			</div>
		</div>
	</div>			
</div>