...
<div class="custom-control custom-checkbox custom-control-inline pl-0">
	<input type="text" class="form-control form-control-sm" size="17" id="otherstxt" name="attendant5" value="<?php echo $row['attendant_type']; ?>"  onkeypress="return isTextKey(event)">
</div>
