...
try {
    ...
    // --- COMPREHENSIVE LIVE DATA MAPPING (For Reprints with Unsaved Changes) ---
    if (isset($_POST['is_live_print']) && $_POST['is_live_print'] == '1') {
        ...
        // Page 2 - Late Registration (Affidavit 2)
    ...
    fitTextInCell($pdf, 132, 311.5, 64, 5, $row['late_administer_position'] ?? ''); // Added missing position
