...
<div class="row" id="row">
    ...
    <div class="container-fluid mb-5">
        <form action="birth_cerf_update_action.php" method="POST">
                ...
                <div class="card-header bg-white pb-3 pt-4 border-bottom-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 d-flex justify-content-between">
                            ...
                            <a href="print_1A.php?no=<?php echo $row['no']; ?>" target="_blank" class="btn btn-light border py-1" style="background: white; width: 24%; text-align: center; text-decoration: none; color: black; font-size: 13px;">Print Form 1A</a>
                            <a href="print_102.php?no=<?php echo $row['no']; ?>" target="_blank" class="btn btn-light border py-1" style="background: white; width: 24%; text-align: center; text-decoration: none; color: black; font-size: 13px;">Print Form 102</a>
