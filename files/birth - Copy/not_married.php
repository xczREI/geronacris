...
<div class="custom-control custom-checkbox custom-control-inline" style="margin-right: 0;">
	<input type="checkbox" class="custom-control-input" id="not_married" name="married_type" value="not married"  checked>
...
<div class="custom-control custom-checkbox custom-control-inline" style="padding: 0; width: 45%;margin-right: 0;">
	<input type="text" class="form-control form-control-sm" id="not_married_txt" name="not_married_name" value="<?php echo $row['not_married_name']; ?>" onkeypress="return isTextKey(event)">
</div>