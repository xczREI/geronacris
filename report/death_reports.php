      ...
      <div class="col-sm-2 mb-1">
          ...
          <?php 
            ...
            if ($conn->connect_error) {
                ...
                // Extract year from registration_tbl or person_tbl as appropriate for death reports
                $sql = "SELECT DISTINCT YEAR(reg_date) AS yr 
                        FROM registration_tbl 
                        WHERE reg_date IS NOT NULL 
                        AND reg_date != '0000-00-00'
                        ORDER BY yr DESC";
        ...
        success:function(data){
          ...
          if(!data || data.length === 0) {
              ...
              for(var i = 0; i < data.length; i++) {
                  ...
                  if(data[i].name) data[i].label = data[i].name; // Handle potential 'name' vs 'label' mismatch
              }
          }
