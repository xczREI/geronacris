...
<div class="row" id="row">
  ...
  <div class="col-sm-9" style="padding-top: 7%;" id="body">
    <div class="row">
      ...
      <div class="col-sm-3">
        <a class="btn btn-outline-info btn-block mb-4" href="account/staff_setting.php?id=<?php echo $_SESSION['id']; ?>"><i class="fa fa-cog fa-fw"></i>Account Setting</a>
      </div>
    </div>
                ...
                <div class="row">
                  <div class="col-5 col-md-4">
                    <div class="icon-big text-center icon-warning">
                      <i class="fa fa-sun-o text-warning" id="icon"></i>
                    </div>
                  </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  <div class="col-5 col-md-4">
                    <div class="icon-big text-center icon-warning">
                      <i class="fa fa-plus text-secondary" id="icon"></i>
                    </div>
                  </div>
                  <div class="col-7 col-md-8">
                    <?php
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  <div class="col-5 col-md-4">
                    <div class="icon-big text-center icon-warning">
                      <i class="fa fa-heart-o text-danger" id="icon"></i>
                    </div>
                  </div>
                  <div class="col-7 col-md-8">
                    <?php
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  <div class="col-5 col-md-4">
                    <div class="icon-big text-center icon-warning">
                      <i class="fa fa-user-o text-primary" id="icon"></i>
                    </div>
                  </div>
                  <div class="col-7 col-md-8">
                    <?php
                    ...
                    ?>
                    <div class="numbers">
                      <h6 class="card-category text-right text-uppercase">User</h6>
                      <h1 class="text-center"><?php echo $rows; ?></h1>
                    </div>
                  </div>
                </div>
